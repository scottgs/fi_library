function [scalar] = fi_get_value_for_specific_variable( query , FMbinary )
...
%	Outputs:
%		scalar = value of query variable
%	Example:
%		[scalar] = fi_get_value_for_specific_variable( [1 3] , FMbinary )
%
% Program description:
%   Get a specific variable in the FM 
